...
const navigation = {
  solutions: [
    { name: 'Shapewear Bodysuits', href: '#' },
    { name: 'High-Waist Shorts', href: '#' },
    { name: 'Post-Surgery Fajas', href: '#' },
    { name: 'Waist Trainers', href: '#' },
    { name: 'Control Panties', href: '#' },
  ],
  support: [
  ...
  social: [
    ...
    // Otros íconos como X, GitHub, YouTube los puedes mantener o quitar según necesidad
  ],
}
...
<>
    ...
    <footer className="bg-pink-50 dark:bg-gray-900">
      <div className="mx-auto max-w-8xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <img
              alt="Company name"
              src="https://green-button.us/wp-content/uploads/2025/05/Enmascarar-grupo-1813.png"
  ...
  Empowering women to feel confident, comfortable, and stylish every day with premium shapewear.
</p>
